...
export const MAX_DATE_CALENDER = dayjs(new Date()).add(0, 'day').toDate()
export const MIN_DATE_CALENDER = dayjs(new Date())
    .subtract(60, 'day')
...
export const FROM_TODAY_DATE_CALENDER = dayjs(new Date())
    .subtract(0, 'day')
...
export const MAX_DISPLAY_LENGTH = 20; // Set your desired maximum display length