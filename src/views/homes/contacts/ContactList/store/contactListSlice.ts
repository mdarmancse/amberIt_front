...
import { apiGetContactList } from '@/services/ContactService'
...
export const SLICE_NAME = 'homesContactList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetContactList<GetResponse, TableQueries>(
            data
        )
