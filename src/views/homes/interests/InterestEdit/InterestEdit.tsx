...
import InterestForm, {
    ...
    OnDeleteCallback,
    SetSubmitting,
} from '@/views/homes/interests/InterestForm'

injectReducer('homeInterestEdit', reducer)
...
const InterestEdit = () => {
    ...
    const data = useAppSelector((state) => state.homeInterestEdit.data.data)
    const loading = useAppSelector(
        (state) => state.homeInterestEdit.data.loading
    )
