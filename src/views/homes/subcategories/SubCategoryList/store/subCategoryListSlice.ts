...
import { apiGetSubCategoryData } from '@/services/SubCategoryService'
...
export const SLICE_NAME = 'homesSubCategoryList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetSubCategoryData<GetResponse, TableQueries>(
            data
        )
