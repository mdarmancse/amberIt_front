...
export const SLICE_NAME = 'homeLiveChannelList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetLiveContentsData<
            GetResponse,
            TableQueries
        >(data)
...
const liveChannleListSlice = createSlice({
...
export const {
    ...
    removeRowItem,
    setDeleteMode,
} = liveChannleListSlice.actions

export default liveChannleListSlice.reducer
