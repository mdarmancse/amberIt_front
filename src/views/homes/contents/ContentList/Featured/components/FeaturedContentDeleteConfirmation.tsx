...
const FeaturedContentDeleteConfirmation = () => {
    const dispatch = useAppDispatch()
    const selectedRows = useAppSelector(
        (state) => state.homeFeaContentList.data.selectedRows
    )
    const selectedRow = useAppSelector(
        (state) => state.homeFeaContentList.data.selectedRow
    )
    const deleteMode = useAppSelector(
        (state) => state.homeFeaContentList.data.deleteMode
    )
    const tableData = useAppSelector(
        (state) => state.homeFeaContentList.data.tableData
    )
...
export default FeaturedContentDeleteConfirmation
