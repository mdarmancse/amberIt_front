...
export const SLICE_NAME = 'homeFeaContentList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetFeaturedContentsData<GetResponse, TableQueries>(
            data
        )
...
const featuredContentListSlice = createSlice({
...
export const {
    ...
    removeRowItem,
    setDeleteMode,
} = featuredContentListSlice.actions

export default featuredContentListSlice.reducer
