...
import MenuForm from '@/views/settings/menus/MenuForm/MenuForm'

injectReducer('homeMenuEdit', reducer)
...
const MenuEdit = () => {
    ...
    const data = useAppSelector((state) => state.homeMenuEdit.data.data)
    const loading = useAppSelector(
        (state) => state.homeMenuEdit.data.loading
    )
