...
import { apiGetCategoryData } from '@/services/CategoryService'
import { apiGetMenuData } from '@/services/MenuService'
...
export const SLICE_NAME = 'homesMenuList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetMenuData<GetResponse, TableQueries>(
            data
        )
