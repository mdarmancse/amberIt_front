...
import { apiGetRoleData } from '@/services/RoleService'
...
export const SLICE_NAME = 'settingRoleList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetRoleData<GetResponse, TableQueries>(data)
