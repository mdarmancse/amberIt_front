...
import { apiGetVersionData } from '@/services/DbVersionService'
...
export const SLICE_NAME = 'settingVersionList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetVersionData<GetResponse, TableQueries>(
            data
        )
...
const versionListSlice = createSlice({
