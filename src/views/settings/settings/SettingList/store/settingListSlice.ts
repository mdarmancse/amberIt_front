...
import { apiGetSettingData } from '@/services/SettingService'
...
export const SLICE_NAME = 'homesSettingList'

export const getDatas = createAsyncThunk(
    SLICE_NAME + '/getDatas',
    async (data: TableQueries) => {
        const response = await apiGetSettingData<GetResponse, TableQueries>(data)
