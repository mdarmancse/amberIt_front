...
import { apiGetActiveUsersReport } from '@/services/ReportService'
...
export const SLICE_NAME = 'activeUserMonthlyReportList'

export const getActiveUserMonthlyReport = createAsyncThunk(
    SLICE_NAME + '/getActiveUserMonthlyReport',
    async (data: TableQueries) => {
        const response = await apiGetActiveUsersReport<
            GetResponse,
            TableQueries
        >(data)
