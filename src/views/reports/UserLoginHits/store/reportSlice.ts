...
import { apiGetLoginLogReport } from '@/services/ReportService'
...
export const SLICE_NAME = 'userLoginReportList'
...
const reportSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getLoginLogReport.fulfilled, (state, action) => {
                state.dataList = action.payload.data
                // @ts-ignore
                state.tableData.total = action.payload.total
                state.loading = false
            })
            .addCase(getLoginLogReport.pending, (state) => {
                state.loading = true
            })
    },
})
