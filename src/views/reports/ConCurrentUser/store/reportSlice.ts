...
import { apiGetConCurrentUserReport } from '@/services/ReportService'
...
export const SLICE_NAME = 'conCurReportList'
...
const reportSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getConCurrentUserReport.fulfilled, (state, action) => {
                state.dataList = action.payload.data
                // @ts-ignore
                state.tableData.total = action.payload.total
                state.loading = false
            })
            .addCase(getConCurrentUserReport.pending, (state) => {
                state.loading = true
            })
    },
})
