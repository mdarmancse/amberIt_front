...
import { apiLiveAudienceDailyReport } from '@/services/ReportService'
...
export const SLICE_NAME = 'liveAudReportList'
...
const reportSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(getLiveAudienceDailyReport.fulfilled, (state, action) => {
                state.dataList = action.payload.data
                // @ts-ignore
                state.tableData.total = action.payload.total
                state.loading = false
            })
            .addCase(getLiveAudienceDailyReport.pending, (state) => {
                state.loading = true
            })
    },
})
