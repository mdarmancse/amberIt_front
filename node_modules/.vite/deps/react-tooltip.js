...
import {
  ...
  offset,
  shift
} from "./chunk-MK67QRNJ.js";
import {
  require_classnames
} from "./chunk-KXT4S3ZG.js";
import {
  require_react
...
var k = async ({ elementReference: e2 = null, tooltipReference: t2 = null, tooltipArrowReference: r2 = null, place: o2 = "top", offset: l2 = 10, strategy: n2 = "absolute", middlewares: i2 = [offset(Number(l2)), flip(), shift({ padding: 5 })] }) => {
  ...
  if (null === t2)
    return { tooltipStyles: {}, tooltipArrowStyles: {}, place: o2 };
  const c2 = i2;
  return r2 ? (c2.push(arrow({ element: r2, padding: 5 })), computePosition(e2, t2, { placement: o2, strategy: n2, middleware: c2 }).then(({ x: e3, y: t3, placement: r3, middlewareData: o3 }) => {
    var l3, n3;
  ...
  })) : computePosition(e2, t2, { placement: "bottom", strategy: n2, middleware: c2 }).then(({ x: e3, y: t3, placement: r3 }) => ({ tooltipStyles: { left: `${e3}px`, top: `${t3}px` }, tooltipArrowStyles: {}, place: r3 }));
};
